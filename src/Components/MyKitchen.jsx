...
export default class MyKitchen extends React.Component {
    ...
    createDishs = () => {
        ...
        const ings3 = [this.ingredients[0], this.ingredients[1], this.ingredients[2], this.ingredients[3], this.ingredients[4], this.ingredients[5], this.ingredients[6]];
        ...
        this.setState(prevState => ({ recipes: [...prevState.recipes, chopSuey, padThai, pho] }))
        this.recipesChanged = true;
        //If I write ...prevState.recipes inside [] before chopSuey,padThai... It will print 6 cards instead of 3
    }
